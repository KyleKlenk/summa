...
To run a test basin, in the main ngen directory, run
    $ cmake_build/ngen data/catchment_data.geojson "USA_09107000" ./data/nexus_data.geojson "nex-26" ./extern/summa/summa/test_ngen/example_realization_config_w_summa_bmi.json
or 
